...
1. Responding the voice command about Technological University TU(Hmawbi) and EC Department
2. Opening Google Chrome and You Tube by using voice command
...
Description:
Accepts a voice command (text) and performs the corresponding action (e.g., open apps, perform searches).
...
Description:
Stops the assistant from listening to commands.
...
What You Can Say
    ...
    Open Apps or Websites:
        ...
        Example: "open youtube" (opens YouTube)

    Click on Buttons:
        Example: "click on submit button"

    Ask Questions:
        Example: "where is Nothern Technological University?"
